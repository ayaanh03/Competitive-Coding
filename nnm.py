...
for i in range(len(a)-7):
    b=b+a[i:i+7]
    if b[0] in string.ascii_uppercase and b[1] in string.ascii_uppercase and b[2] in string.ascii_uppercase and b[4] in string.ascii_uppercase and b[5] in string.ascii_uppercase and b[6] in string.ascii_uppercase and b[3] in string.ascii_lowercase:
        print(b)
    b=""
print(b)
